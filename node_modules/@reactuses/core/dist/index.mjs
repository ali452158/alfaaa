...
const useEyeDropper = ()=>{
    ...
    const open = useCallback((options = {})=>_async_to_generator$8(function*() {
            if (!isSupported) {
                return {
                    sRGBHex: ''
                };
...
const useMediaDevices = (options = {})=>{
    ...
    const ensurePermissions = useCallback(()=>_async_to_generator$5(function*() {
            if (!isSupported) {
                return false;
            }
...
const useMicrophone = (options = {})=>{
    ...
    const lastLevelEmitRef = useRef(-Infinity);
    const levelIntervalRef = useRef(levelInterval);
    useEffect(()=>{
    ...
    const buildAudioGraph = useCallback((s)=>{
